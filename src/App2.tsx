...
// import { DesktopPetsScreen } from "./components/DesktopPetsScreen";
...
//           )}
//           {currentScreen === "pets" && (
//             <PetsScreen onNavigate={handleNavigate} />
//           )}
...
//         <DesktopSidebar
//           active={getActiveScreen() as "timeline" | "groups" | "friends" | "pets" | "profile"}
...
//         )}
//         {currentScreen === "pets" && (
//           <DesktopPetsScreen onNavigate={handleNavigate} />
//         )}
//         {currentScreen === "profile" && (
